---
name: strength
description: Kuba's lifting — his strength workouts from Garmin, and the rolling per-muscle load that tracks progressive overload. Use whenever a message touches lifting or training load — did you see my workout, can you check my lift, did my workout sync, log my lifting, what did I lift, my sets today, how much did I lift, how'd my arm day go, how'd leg day go; and the trend, including casual "how's X looking / what's X looking like" phrasing — how's my volume, how are my arms looking, what's the arms looking like, how's my chest looking, what do my legs look like, my chest volume, back volume this week, how are my legs, my arms, my biceps, my triceps, my shoulders, am I progressing, progressive overload, my training load, my strength load, ACWR, am I overtraining or undertraining, am I recovered enough to push, plot my load, show me my strength chart, how's my lifting going this week. Muscles tracked: legs, chest, back, shoulders, biceps, triceps — "arms" means biceps + triceps. Use it before answering whether a lift logged at all, since the database is the only way to know.
---
